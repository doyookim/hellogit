class CookieHelper {
    ...
    /**
     * 쿠키를 저장한다. 저장시 이름과 같은 값은 내부에서 urlencoding 처리한다.
     * @param {string} name - 저장할 쿠키의 이름
     * @param {string} value - 저장할 쿠키의 값
     * @param {json} option - 유효시간, 유효경로, 도메인 등을 json으로 묶어서 보낸다.
     */
    setCookie(name, value, options = {}) {
        ...
        // expires 값이 Date 클래스의 객체라면 UTCString 타입으로 변홤함. (max-age가 있으면 사용 안해도 됨)
        // --> 2011-11-25ㅆ05:09:30.569Z
    ...
    getCookie(name) {
        // 주어진 이름에 대한 "; name<value>" 패턴을 찾아 <value> 부분만 반환함
