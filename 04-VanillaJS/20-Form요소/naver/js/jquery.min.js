/*! jQuery v1.11.1 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function(a, b) {
    ...
    m.extend({
            ...
            buildFragment: function(a, b, c, d) {
                for (
                    var e, f, g, h, i, j, l, n = a.length, o = db(b), p = [], q = 0; n > q; q++
                )
                    if (((f = a[q]), f || 0 === f))
                    ...
                    if (
                        (!k.leadingWhitespace &&
                            hb.test(f) &&
                            p.push(b.createTextNode(hb.exec(f)[0])), !k.tbody)
                    ) {
                        (f =
                            "table" !== i || kb.test(f) ?
                            "<table>" !== l[1] || kb.test(f) ?
        ...
        m.fn.extend({
            ...
            domManip: function(a, b) {
                ...
                if (
                    ...
                    if (f)
                        for (
                            h = g[g.length - 1].ownerDocument, m.map(g, yb), j = 0; f > j; j++
                        )
                            (d = g[j]),
                            ob.test(d.type || "") &&
    ...
    function hc(a, b, c) {
        for (
            var d, e = (ec[b] || []).concat(ec["*"]), f = 0, g = e.length; g > f; f++
        )
