...
(function(nclkExports) {
     ...
     * 4/23 �댄썑 SSC濡쒕쭔 �ъ슜
     * NSC�� deprecated
     * �댁쟾 踰꾩쟾�� 寃쎌슦 NSC瑜� �ъ슜�섏뿬 �덉뒪�좊━ �④린�� 紐⑹쟻�쇰줈 �꾨옒 肄붾뱶 二쇱꽍 泥섎━
    ...
    // 2018-12-20 援� nclks_select 瑜� �숈씪�섍쾶 泥섎━�섍린 �꾪빐 customizing ��. by nullism
    // nclk_v2_select(this.value,'log.lankr',{'ko_KR':'log.lankr','en_US':'log.lanen','zh-Hans_CN':'log.lancn','zh-Hant_TW':'log.lantw'},this,event) �뺥깭濡� �ъ슜��.
    ...
    nclk.sd = function(l, func) {
        ...
        if (f) {
            timer = setTimeout(function() {
                func();
            }, 5000); // if we don't receive image response in 5s, absolutly go page
        }
            ...
            if (ifrId) {
                ...
                if (theEvent.clientX && theEvent.clientX != undefined) {
                    ...
                    if (dBody.clientLeft && dBody.clientTop) {
                        ...
                        // firefox bug - clientLeft, clientTop don't work in firefox. It is OK in firefox 3.0
        ...
        try {
            ...
            if (!!etc === false || !!etc.pid === false) {
                ...
                if (window.g_pid) {
                    ...
                    // lpid 愿��� 泥섎━
                    // pid �앹꽦
                    pidFallback = lcs_get_lpid(); // lcs_do �댁쟾�� 李몄“�섏뿬 �앹꽦�� �� �덈뒗 寃쎌슦 怨좊젮
                }
                // pid
