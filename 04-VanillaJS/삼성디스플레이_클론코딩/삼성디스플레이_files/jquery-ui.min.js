...
(function(t) {
    ...
    function n(e) {
        ...
        return e
            .on("mouseout", i, function() {
                t(this).removeClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") &&
                    t(this).removeClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") &&
    ...
    function o() {
        t.datepicker._isDisabledDatepicker(
            ...
            (t(this)
                ...
                t(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") &&
                t(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") &&
    ...
    (t.widget = function(e, i, s) {
        ...
        return (
            ...
            (o.prototype = t.widget.extend(
                a, { widgetEventPrefix: n ? a.widgetEventPrefix || e : e },
                r, { constructor: o, namespace: h, widgetName: e, widgetFullName: l }
            )),
            n ?
    ...
    (t.Widget.prototype = {
        ...
        option: function(e, i) {
            ...
            if ("string" == typeof e)
                if (((a = {}), (s = e.split(".")), (e = s.shift()), s.length)) {
                    for (
                        n = a[e] = t.widget.extend({}, this.options[e]), o = 0; s.length - 1 > o; o++
                    )
                        (n[s[o]] = n[s[o]] || {}), (n = n[s[o]]);
        ...
        _classes: function(e) {
            ...
            var s = [],
                n = this;
            return (
                (e = t.extend({ element: this.element, classes: this.options.classes || {} },
                    e
                )),
            ...
            (c.hsla.to = function(t) {
                ...
                return (
                    (e =
                        ...
                        (60 * (o - s)) / l + 120 :
                        (60 * (s - n)) / l + 240),
                    (i = 0 === l ? 0 : 0.5 >= u ? l / c : l / (2 - c)), [Math.round(e) % 360, i, u, null == a ? 1 : a]
                );
            }),
    ...
    t.effects.define("blind", "hide", function(e, i) {
        ...
        t.effects.define("pulsate", "show", function(e, i) {
            var s = t(this),
                ...
                d = s.queue().length;
            for (
                (o || !s.is(":visible")) && (s.css("opacity", 0).show(), (c = 1)); h > u; u++
            )
        ...
        t.widget("ui.autocomplete", {
                        ...
                        menufocus: function(e, i) {
                            ...
                            return this.isNewMenu &&
                                ...
                                (this.menu.blur(),
                                    ...
                                    void 0) :
                                ((n = i.item.data("ui-autocomplete-item")), !1 !== this._trigger("focus", e, { item: n }) &&
                                    e.originalEvent &&
            ...
            __response: function(t) {
                t && (t = this._normalize(t)),
                    this._trigger("response", null, { content: t }), !this.options.disabled && t && t.length && !this.cancelSearch ?
    ...
    t.extend(s.prototype, {
            ...
            _showDatepicker: function(e) {
                if (
                    ((e = e.target || e),
                        ...
                        (e = t("input", e.parentNode)[0]), !t.datepicker._isDisabledDatepicker(e) && t.datepicker._lastInput !== e)
                ) {
                    var s, n, o, r, h, l, c;
            ...
            _findPos: function(e) {
                for (
                    var i, s = this._getInst(e), n = this._get(s, "isRTL"); e &&
                ...
                e.dpDiv.find("[data-handler]").map(function() {
                    var e = {
                        ...
                        selectDay: function() {
                            return (
                                t.datepicker._selectDay(
                                    s, +this.getAttribute("data-month"), +this.getAttribute("data-year"),
                                    this
                                ), !1
                            );
                        },
                ...
                if ((v || (b += y + (!o && m && _ ? "" : "&#xa0;")), !t.yearshtml))
                    if (((t.yearshtml = ""), o || !_))
                        ...
                        for (
                            ...
                            t.yearshtml +=
                            "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; g >= f; f++
                        )
                            t.yearshtml +=
                            "<option value='" +
                            f +
        ...
        (t.fn.datepicker = function(e) {
            ...
            return "string" != typeof e ||
                ...
                t.datepicker["_" + e + "Datepicker"].apply(
                    t.datepicker, [this[0]].concat(i)
                ) :
                this.each(function() {
                    "string" == typeof e
                        ?
                        t.datepicker["_" + e + "Datepicker"].apply(
                            t.datepicker, [this].concat(i)
                        ) :
        ...
        t.widget("ui.resizable", t.ui.mouse, {
            ...
            _proportionallyResize: function() {
                if (this._proportionallyResizeElements.length)
                    for (
                        var t, e = 0, i = this.helper || this.element; this._proportionallyResizeElements.length > e; e++
                    )
    ...
    t.uiBackCompat !== !1 &&
        ...
        t.widget("ui.slider", t.ui.mouse, {
            ...
            values: function(e, i) {
                ...
                for (
                    s = this.options.values, n = arguments[0], o = 0; s.length > o; o += 1
                )
            ...
            _setOption: function(e, i) {
                ...
                switch (
                    ...
                    case "values":
                        for (
                            this._animateOff = !0, this._refreshValue(), s = n - 1; s >= 0; s--
                        )
                            this._change(null, s);
                        this._animateOff = !1;
                        break;
            ...
            _refreshValue: function() {
                ...
                this._hasMultipleValues() ?
                    this.handles.each(function(s) {
                        ...
                        t(this).stop(1, 1)[l ? "animate" : "css"](c, r.animate),
                            ...
                            ("horizontal" === h.orientation ?
                                (0 === s &&
                                    h.range
                                    .stop(1, 1)[l ? "animate" : "css"]({ left: i + "%" }, r.animate),
                                    1 === s &&
                                    h.range[l ? "animate" : "css"]({ width: i - e + "%" }, { queue: !1, duration: r.animate })) :
                                (0 === s &&
                                    h.range
                                    .stop(1, 1)[l ? "animate" : "css"]({ bottom: i + "%" },
                                        r.animate
                                    ),
                                    1 === s &&
                    ...
                    ((s = this.value()),
                        ...
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ width: i + "%" }, r.animate),
                        "max" === a &&
                        "horizontal" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ width: 100 - i + "%" }, r.animate),
                        "min" === a &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ height: i + "%" }, r.animate),
                        "max" === a &&
                        "vertical" === this.orientation &&
                        this.range
                        .stop(1, 1)[l ? "animate" : "css"]({ height: 100 - i + "%" }, r.animate));
            },
            _handleEvents: {
                keydown: function(e) {
                    var i,
                    ...
                    switch (e.keyCode) {
                        ...
                        case t.ui.keyCode.LEFT:
                            if (
                                (e.preventDefault(), !this._keySliding &&
                                    ((this._keySliding = !0),
        ...
        t.widget("ui.tabs", {
            ...
            _initialActive: function() {
                ...
                return (
                    ...
                    e !== !1 &&
                    ((e = this.tabs.index(this.tabs.eq(e))), -1 === e && (e = i ? !1 : 0)), !i && e === !1 && this.anchors.length && (e = 0),
                    e
                );
            },
            _getCreateEventData: function() {
