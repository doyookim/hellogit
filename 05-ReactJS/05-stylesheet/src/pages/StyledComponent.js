 ...
 *
 * VSCode안에서 styled-components 지원을 위한 확장프로그램
...
/** ul태그로 구성된 컴포넌트 정의 --> styled.태그이름 `` ; (역따옴표 추의)*/
const MyGrindContainer = styled.ul`
  /** SCSS 코딩 진행 */
  list-style: none;
  padding: 0;
  margin: 0;
...
const StyledComponent = () => {
  ...
  return (
    <div>
      ...
      <h3>단순 태그처럼 사용</h3>
      <MyGrindContainer>
        {/* MyGrindItem에게 width라는 이름의 변수값 전달 */}
        <MyGridItem width={"30%"}>
          <MyBox>Itme1</MyBox>
        </MyGridItem>
        <MyGridItem width={"10%"}>
