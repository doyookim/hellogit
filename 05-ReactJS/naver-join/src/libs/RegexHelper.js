...
class RegexHelper {
  ...
  /**
   * 숫자로만 이루어 졌는지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  num(field, msg) {
  ...
  /**
   * 영문으로만 이루어 졌는지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  eng(field, msg) {
  ...
  /**
   * 한글로만 이루어 졌는지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  kor(field, msg) {
  ...
  /**
   * 영문과 숫자로 이루어 졌는지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  engNum(field, msg) {
  ...
  /**
   * 한글과 숫자로만 이루어 졌는지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  korNum(field, msg) {
  ...
  /**
   * 이메일 주소 형식인지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  email(field, msg) {
  ...
  /**
   * 핸드폰 번호 형식인지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  cellphone(field, msg) {
  ...
  /**
   * 집전화 형식인지 검사하기 위해서 field()를 간접적으로 호출한다.
   * @param {HTMLElement} field 검사할 대상의 CSS 선택자
   * @param {string} msg 표시할 메시지
   */
  telphone(field, msg) {
