...
const Titanic = () => {
  ...
  return (
    <div>
      ...
      <SeleectContainer>
        <select name="sex" onChange={onSelecetChange}>
          <option value="">-- 성별 선택 --</option>
          <option value="male">남자</option>
          <option value="female">여자</option>
        </select>

        <select name="embarked" onChange={onSelecetChange}>
          <option value="">-- 탑승지 선택 --</option>
          <option value="C">세르부르</option>
          <option value="Q">퀸즈타운</option>
          <option value="S">사우샘프턴</option>
        </select>

        <select name="survived" onChange={onSelecetChange}>
